...
If you find a bug (the website couldn't handle the query and / or gave undesired results), kindly open an issue [here](https://github.com/MRBlach/fetch-example-api/issues/new) by including your search query and the expected result.

If you'd like to request a new function, feel free to do so by opening an issue [here](https://github.com/MRBlach/fetch-example-api/issues/new). Please include sample queries and their corresponding results.
...
+ Thanks to **JSON Placehoder** for supporting us with a [free fake online REST API data](https://jsonplaceholder.typicode.com/)
+ Thanks to **Dog.CEO** for providing the [free API for open source dog photos](https://dog.ceo/dog-api/)

### You may also like..

+ [Dog API](https://github.com/MRBlach/dog-api "Dog API") - Example of API fetch for dog photos